...
Cette écriture peut être utile avec des débutants mais elle utilise beaucoup d'encre.
...
\newparaexample{Écriture \og universiatire \fg}
...
La macro \macro{crossprod} possède un argument optionnel que l'on peut utiliser pour obtenir la mise ne forme suivante.
...
\newparaexample{Explication du mode de calcul}
